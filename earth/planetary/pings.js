...
(function () {
  ...
  // Load custom `autorotate` plugin; see below.
  ...
  // Load custom `lakes` plugin to draw lakes; see below.
    ...
    return function (planet) {
      ...
      planet.onDraw(function () {
        if (paused || !lastTick) {
          ...
          // THis plugin uses the build-in projection (provided by D3)
  ...
  // This plugin takes lake data and draws them on the map.
